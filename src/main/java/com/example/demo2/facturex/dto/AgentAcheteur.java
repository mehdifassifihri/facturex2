...
@XmlRootElement(name = "BuyerAgentTradeParty")
...
public class AgentAcheteur {
    ...
    private String raisonSocialeAgentAcheteur;
    ...
    public String getRaisonSocialeAgentAcheteur() {
        return raisonSocialeAgentAcheteur;
    }

    public void setRaisonSocialeAgentAcheteur(String raisonSocialeAgentAcheteur) {
        this.raisonSocialeAgentAcheteur = raisonSocialeAgentAcheteur;
    }
